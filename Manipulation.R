...
# Importing dataset
################################################################################
##Note: the dataset does not have column header
...
#method 1: 
#at t the point of applying the rename to the sex column with the 
#ifelse statement and creating a new column called gender which is a factor
###############################################################################
...
################################################################################
#Creating a new column with ifelse statemet for more thn one condition
################################################################################
library(readxl)
